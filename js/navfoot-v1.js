        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="nav-link" href="/pages/bookstore/merch-list.html"
                >所有商品</a
              >
            </li>
            <li class="nav-item active">
              <a class="nav-link" href="/pages/activity/bookmarket.html"
                >活動講座</a
              >
            </li>
            <li class="nav-item active">
            ...
            <li class="nav-item active">
              <a
                class="nav-link"
                href="/pages/style-guide-draft/style-guide-draft.html"
                >Style Guide稿</a
              >
            </li>
            <li class="nav-item active">
          ...
          <ul class="navbar-nav">
            <li class="nav-item active mx-2">
              <a class="nav-link" href="/pages/cart/cart-index.html"
                ><i class="fas fa-shopping-cart"></i
              ></a>
            </li>
            <li class="nav-item active mx-2">
              <a class="nav-link" href="/pages/members/register.html"
