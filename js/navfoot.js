    ...
    >
      <div class="container col-12" style="padding: 0 16px">
        <a
          class="navbar-brand"
          href="/"
          style="padding-left: 8px; padding-right: 18px"
        >
          <!-- LOGO SVG -->
          <svg
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item honki-nav-item active">
              <a
                ...
                href="/pages/bookstore/merch-list.html"
                >所有商品</a
              >
            </li>
            <li class="nav-item honki-nav-item active">
            ...
            <li class="nav-item honki-nav-item active">
              <a
                class="nav-link honki-nav-link nav-item-60px"
                href="/pages/used-books/used-books-index.html"
                >二手交換</a
              >
            </li>
            <li class="nav-item honki-nav-item active">
              <a class="nav-link honki-nav-link nav-item-60px" href="＃"
                >讀者感言</a
              >
            </li>
            <li class="nav-item honki-nav-item active">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item honki-nav-link-fa active">
              <a
                class="nav-link zero-padding"
                href="/pages/members/register.html"
            ...
            <li class="nav-item honki-nav-link-fa active">
              <a
                class="nav-link zero-padding"
                href="/pages/cart/cart-index.html"
      ...
      <div class="nav-mobile-right d-flex">
        <a href="#" class="nav-mobile-link">
          <svg
            ...
            y="0px"
            viewBox="0 0 117 111"
            style="enable-background: new 0 0 117 111"
            xml:space="preserve"
          >
            <g>
              <path
          ...
          <i class="fas fa-user nav-mobile-icons"></i>
        </a>
        <a href="#" class="nav-mobile-link">
          <svg
            version="1.1"
        ...
        <a href="#" class="nav-mobile-link nav-burger">
          <svg
            version="1.1"
            id="レイヤー_1"
            xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="accordion menu-open mx-auto" id="accordionExample">
        <div class="card">
          <div class="card-header" id="headingOne">
            <h2 class="mb-0">
              <button class="btn btn-link" type="button">首頁</button>
            </h2>
          </div>
        </div>
        <div class="card">
...
footerTemplate.innerHTML = `    <footer class="desktopfooter">
<div class="top d-flex">
    <img src="/images/style-guide/footeritem.svg" width="185px" height="118px">
    <div class="circle mt-4 ml-3 d-flex flex-column"><i class="fas fa-caret-up"></i>
...
<div class="container">
    <div class="row justify-content-around footer_head">
        <div class="footer-info d-flex flex-cloumn col-12 col-md">
            <a href="#" class="logo"><img src="/images/style-guide/logo.svg" width="72px" height="55px"></a>
        </div>
        <div class="footer-info d-flex flex-cloumn col-12 col-md">
            <dl>
                <dt class="contactus">聯絡我們</dt>
                <dd><a class="footer-link" href="#">服務電話</a></dd>
                <dd><a class="footer-link" href="#">honki@mail.com</a></dd>
                <dd>台灣台北市</dd>
            </dl>
        </div>
        <div class="footer-info d-flex flex-cloumn col-12 col-md">
            <dl>
                ...
                <dd><a class="footer-link" href="#">加入會員</a></dd>
                <dd><a class="footer-link" href="#">查詢帳號密碼</a></dd>
                <dd><a class="footer-link" href="#">訂單查詢</a></dd>
                <dd><a class="footer-link" href="#">退換貨</a></dd>
            </dl>
        </div>
        <div class="footer-info d-flex flex-cloumn col-12 col-md">
            <dl>
                <dt class="contactus">更多資訊</dt>
                <dd><a class="footer-link" href="#">關於HONKI</a></dd>
                <dd><a class="footer-link" href="#">工作機會</a></dd>
                <dd><a class="footer-link" href="#">服務條款</a></dd>
                <dd><a class="footer-link" href="#">合作洽談</a></dd>
            </dl>
        </div>
    </div>
</div>
...
<div class="top d-flex">
    <img class="topimg" src="/images/style-guide/footeritem.svg">
    <div class="circle mt-4 ml-3 d-flex flex-column"><i class="fas fa-caret-up"></i>
        <sapn class="top_v">TOP</sapn>
    </div>
</div>
<div class="container">
    <div class="row justify-content-center footer_head">
        <div class="footer-header d-flex flex-cloumn col-12 col-md justify-content-center">
            <a href="#" class="logo"><img src="/images/style-guide/logo.svg" width="48px" height="37px"></a>
        </div>
        ...
        <div class="footer-info d-flex col-12 justify-content-center">
            <dl class="infomation d-flex ">
                <div class="contact a">
                    <dt class="contactus"
                        style="width:80px; margin-right:-8px; margin-left:-18px; margin-top:-1px;">聯絡我們</dt>
                </div>
                <div class="footer-link service" style="margin-left:-5px; margin-right:-24px;">
                    <dd><a class="footer-link" href="#">服務電話</a></dd>
                    <dd><a class="footer-link" href="#">honki@mail.com</a></dd>
        ...
        <div class="footer-info d-flex d-flex col-12 justify-content-center ">
            <dl class="infomation d-flex">
                <div class="contact a">
                    <dt class="contactus" style="margin-right:25px;margin-left:-20px;">更多資訊</dt>
                </div>
                <div class="footer-link service" style="margin-left:-25px">
...
<div class="container-fluid ">
    ...
    <div class="footer-info   col-12 ">
        <div class="infomation d-flex justify-content-center">
            <div class="contact a">
                <p class="contactus" style="width:80px; margin-right:0px; margin-left:5px; margin-top:-1px;">
                    聯絡我們
                </p>
            </div>
            <div class="test" style="margin-left:3px;">
                <a class="footer-link" href="#">服務電話</a><br>
                <a class="footer-link" href="#">honki@mail.com</a><br>
                <p class="footer-link" href="#" style="margin-bottom:0px;">台灣台北市</p><br>
            </div>
        </div>
    </div>
    <div class="footer-info   col-12" style="margin-bottom:55px;">
        <div class="infomation d-flex justify-content-center">
            <div class="contact a">
                <p class="contactus" style="width:80px; margin-left:-1px;margin-right:2px; margin-top:-1px;">
                    書城服務</p>
            </div>
            <div class="test ">
                <a class="footer-link" href="#">加入會員</a><br>
                <a class="footer-link" href="#">查詢帳號密碼</a><br>
                <a class="footer-link" href="#">訂單查詢</a><br>
                <a class="footer-link" href="#">退換貨</a>
            </div>
        </div>
    </div>
    ...
    <div class="footer-info   col-12">
        <div class="infomation d-flex justify-content-center">
            <div class="contact a">
                <p class="contactus" style="width:80px; margin-left:-20px;  margin-right:0px;margin-top:-1px;">
                    更多資訊</p>
            </div>
            <div class="test ">
                <a class="footer-link" href="#">關於HONKI</a><br>
                <a class="footer-link" href="#">工作機會</a><br>
                <a class="footer-link" href="#">服務條款</a><br>
                <a class="footer-link" href="#">合作洽談</a>
            </div>
        </div>
    </div>
